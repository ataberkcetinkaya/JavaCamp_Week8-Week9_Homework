...
public class EmailActivation {
	...
	@Builder
	public EmailActivation(@NotNull final User user, @NotBlank @Size(max = 200, min = 0) final String activationCode,
			@NotBlank @Size(max = 100, min = 0) final String email, @NotNull final boolean isActivated,
	...
	@Builder
	public EmailActivation(@NotNull final User user, @NotBlank @Size(max = 200, min = 0) final String activationCode,
			@NotBlank @Size(max = 100, min = 0) final String email, @NotNull final LocalDateTime expirationDate,
